...
import com.bortxapps.goprocontrollerexample.screens.cameracontrol.status.CameraStatusScreenState
            ...
            Column(modifier = Modifier.padding(paddingValues)) {
                state.let {
                    when (it) {
                        ...
                        is CameraStatusScreenState.Error -> ErrorText(this, it.error)
