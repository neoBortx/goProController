...
enum class QUERY_PARAM_SETTING_FRAME_RATE(val id: String) {
    FRAME_RATE_240("0"),
    FRAME_RATE_120("1"),
    FRAME_RATE_100("2"),
    FRAME_RATE_60("4"),
...
enum class QUER_PARAM_SETTINGS_RESOLUTION(val id: String) {
    RESOLUTION_4K("1"),
    RESOLUTION_2_7K("4"),
    RESOLUTION_1080("9"),
    RESOLUTION_4K_GOPRO_12("102"),
    RESOLUTION_53K_GOPRO_12("101"),
    RESOLUTION_1080_GOPRO_12("106"),
}