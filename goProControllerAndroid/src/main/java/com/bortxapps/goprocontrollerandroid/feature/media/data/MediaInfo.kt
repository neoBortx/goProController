...
data class MediaInfo(
    ...
    val avcPprofile: UByte? = null, // Advanced Video Codec Profile (0..255)
    @SerialName("cl")
    val cl: UInt? = null, // File clipped from another source? (0:false, 1:true)
    @SerialName("cre")
    ...
    @SerialName("eis")
    val eis: UInt? = null, // File made with Electronic Image Stabilization (0:false, 1:true)
    @SerialName("fps")
    val fps: UInt? = null, // Frame rate (numerator)
    @SerialName("fps_denom")
    val fpsDenom: UInt? = null, // Frame rate (denominator)
    @SerialName("gumi")
    ...
    @SerialName("hdr")
    val hdr: UInt? = null, // Photo taken with High Dynamic Range? (0:false, 1:true)
    @SerialName("hi")
    ...
    @SerialName("mp")
    val mp: UInt? = null, // Metadata Present? (0:no metadata, 1:metadata exists)
    @SerialName("profile")
    val profile: UByte? = null, // Advanced Video Codec Level (0..255)
    @SerialName("prog")
    val prog: UInt? = null, // Is video progressive? (0:interlaced, 1:progressive)
    @SerialName("pta")
    val pta: UInt? = null, // Media has Protune audio file? (0:false, 1:true)
    @SerialName("raw")
    val raw: UInt? = null, // Photo has raw version? (0:false, 1:true)
    @SerialName("s")
    val s: ULong? = null, // File size in bytes
    @SerialName("subsample")
    val subsample: UInt? = null, // Is video subsampled? (0:false, 1:true)
    @SerialName("tr")
    val tr: UInt? = null, // Is file transcoded? (0:false, 1:true)
    @SerialName("w")
    val w: UInt? = null, // Width of media in pixels (1920)
    @SerialName("wdr")
    val wdr: UInt? = null // Photo taken with Wide Dynamic Range? (0:false, 1:true)
)
